    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑球员信息</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">编辑球员信息</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">球员信息信息</h3>
                        <form id="addOrUpdateForm">
                            <div class="form-row">
                                   ...
                                   <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>籍贯</label>
                                        <input id="jiguan" name="jiguan" class="form-control"
                                               placeholder="籍贯">
                                    </div>
                                <div class="form-group col-md-6">
                                    <label>年龄</label>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input id="height" name="height" class="form-control"
                                           onchange="heightChickValue(this)"  placeholder="身高体重">
                                </div>

                                <div class="form-group col-md-6">
                                    <label>场均得分</label>
                                    <input id="averaged" name="averaged" class="form-control"
                                           onchange="averagedChickValue(this)"  placeholder="场均得分">
                                </div>

                                <div class="form-group col-md-6">
                                    <label>场均篮板数</label>
                                    <input id="backboard" name="backboard" class="form-control"
                                           onchange="backboardChickValue(this)"  placeholder="场均篮板数">
                                </div>

                                <div class="form-group col-md-6">
                                    <label>场均助攻数</label>
                                    <input id="assists" name="assists" class="form-control"
                                           onchange="assistsChickValue(this)"  placeholder="场均助攻数">
                                </div>
                                   ...
                                   <div class="form-group col-md-6">
                                       <label>所属球队</label>
                                       <select id="qdTypesSelect" name="qdTypes" class="form-control">
                                       </select>
                                   </div>
                                    <div class="form-group col-md-6">
                                        <label>手机号</label>
...
<script>
    ...
    function initializationQdtypesSelect(){
        var qdTypesSelect = document.getElementById('qdTypesSelect');
            for (var i = 0; i < qdTypesOptions.length; i++) {
                qdTypesSelect.add(new Option(qdTypesOptions[i].name,qdTypesOptions[i].id));
            }
    }
    // 下拉框选项回显
    function setSelectOption() {
        ...
        for (var i = 0; i < qdTypesOptions.length; i++) {
            if(qdTypesOptions[i].id == ruleForm.qdTypes){//下拉框value对比,如果一致就赋值汉字
                document.getElementById("qdTypesSelect").options[i].selected = true;
            }
        }
    }
    ...
    //搜素输入检查
            ...
            function backboardChickValue(e){
                var this_val = e.value || 0;
                var reg=/^[0-9]*$/;
                if(!reg.test(this_val)){
                    e.value = "";
    ...
    function dataBind() {
        ...
        $("#height").val(ruleForm.height);
        $("#averaged").val(ruleForm.averaged);
        $("#backboard").val(ruleForm.backboard);
        $("#assists").val(ruleForm.assists);
    ...
    function readonly() {
        if (window.sessionStorage.getItem('role') != '管理员') {
            $('#qdTypesSelect').attr('style', 'pointer-events: none;');
        }
    }
