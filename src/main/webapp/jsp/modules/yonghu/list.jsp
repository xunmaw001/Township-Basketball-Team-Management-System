    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">球员信息管理</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">球员信息管理</li>
                        <li class="breadcrumb-item active">球员信息列表</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">球员信息列表</h3>
                        <div class="table-responsive mb-3">
                            <div class="col-sm-12">
                                        ...
                                        <label>
                                            ...
                                            <label>
                                                所属球队
                                                <select name="qdTypesSelectSearch" id="qdTypesSelectSearch" class="form-control form-control-sm"
                                                        aria-controls="tableId">
                                                </select>
                                            </label>
                            ...
                            <table id="tableId" class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <th>头像</th>
                                    <th onclick="sort('jiguan')">籍贯</th>
                                    <th onclick="sort('age')">年龄</th>
                                    <th onclick="sort('height')">身高体重</th>
                                    <th onclick="sort('averaged')">场均得分</th>
                                    <th onclick="sort('backboard')">场均篮板数</th>
                                    <th onclick="sort('assists')">场均助攻数</th>
                                    <th onclick="sort('sexTypes')">性别</th>
                                    <th onclick="sort('qdTypes')">所属球队</th>
...
<script>
    ...
    function search() {
        ...
        var qdTypesIndex = document.getElementById("qdTypesSelectSearch").selectedIndex;
        var qdTypesValue;
        if( qdTypesIndex  == 0){
                qdTypesValue='';
        }else{
                qdTypesValue= document.getElementById("qdTypesSelectSearch").options[qdTypesIndex].value;
        }

        searchForm.qdTypes = qdTypesValue;
    ...
    function setDataRow(item, number) {
        ...
        heightCell.innerHTML = item.height;
        row.appendChild(heightCell);

        var averagedCell = document.createElement('td');
        averagedCell.innerHTML = item.averaged;
        row.appendChild(averagedCell);

        var backboardCell = document.createElement('td');
        backboardCell.innerHTML = item.backboard;
        row.appendChild(backboardCell);

        var assistsCell = document.createElement('td');
        assistsCell.innerHTML = item.assists;
        ...
        var qdTypesCell = document.createElement('td');
        for (var i = 0; i < qdTypesOptions.length; i++) {
            if(qdTypesOptions[i].id == item.qdTypes){//下拉框value对比,如果一致就赋值汉字
                    qdTypesCell.innerHTML = qdTypesOptions[i].name;
            }
        }
        row.appendChild(qdTypesCell);
    ...
    function remove(id) {
        ...
        if (mymessage == true) {
            http("yonghu/delete?ids="+id, "get", {}, (res) => {
                if(res.code == 0
        )
            {
                getDataList();
    ...
    //填充搜索下拉框
            ...
            function qdTypesSelectSearch() {
                var qdTypesSelectSearch = document.getElementById('qdTypesSelectSearch');
                    qdTypesSelectSearch.add(new Option('请选择',''));
                for (var i = 0; i < qdTypesOptions.length; i++) {
                        qdTypesSelectSearch.add(new Option(qdTypesOptions[i].name,qdTypesOptions[i].id));
                }
            }
    ...
    //查询当前页面下所有列表
        ...
        function qdTypesSelect() {
            //填充下拉框选项
            http("qiudui/page?page=1&limit=100&sort=&order=&dicCode=qd_types", "GET", {}, (res) => {
                if(res.code == 0){
                    qdTypesOptions = res.data.list;
            }
        });
        }
    //跨表
